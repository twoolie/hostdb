...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DHCPOptions.code'
        db.alter_column('hdb_dhcpoptions', 'code', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'DHCPOptions.code'
        db.alter_column('hdb_dhcpoptions', 'code', self.gf('django.db.models.fields.IntegerField')())
